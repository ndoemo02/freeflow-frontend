...
import { User, Settings, LogOut, ChevronDown, Bell, Shield, Home, ShoppingCart } from "lucide-react";
...
const useUserStore = create((set) => ({
  ...
  logout: () => {
    set({ user: null, notifications: 0 });
    // Redirect to login
  }
}));

export default function RouterUserPanel() {
