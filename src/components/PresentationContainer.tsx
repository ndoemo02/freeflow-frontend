...
export default function PresentationContainer({ onSelect }: PresentationContainerProps) {
        ...
        return (
            <div
                ...
                className={`
                    ...
                    border
                    ${isActive
                        ? 'opacity-100 scale-105 border-amber-400/80 bg-[#0f0f11] shadow-[0_10px_40px_-10px_rgba(251,191,36,0.5)] z-20'
                        : 'opacity-60 scale-95 border-white/10 bg-[#000000] hover:opacity-100 hover:border-white/30'
                    }
                    backdrop-blur-xl
                `}
                style={{
    ...
    return (
        <div className="fixed inset-x-0 bottom-[140px] md:bottom-[120px] z-50 flex flex-col items-center pointer-events-none">
            <div
